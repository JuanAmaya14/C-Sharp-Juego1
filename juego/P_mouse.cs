...
namespace juego
{
    public partial class P_mouse : Form
    {
        ...
        SoundPlayer June_Remix = new SoundPlayer();
        ...
        SoundPlayer June_Original = new SoundPlayer();
        ...
        {
            June_Remix.SoundLocation = "C:/Users/JuanK/Desktop/C-Sharp-Juego1-main/juego/Audio/RJD2/june-remix.wav";
            June_Remix.Play();
        ...
        private void juneOriginalToolStripMenuItem_Click(object sender, EventArgs e)
        {

            June_Original.SoundLocation = "C:/Users/JuanK/Desktop/C-Sharp-Juego1-main/juego/Audio/RJD2/June-original.wav";
            June_Original.Play();
